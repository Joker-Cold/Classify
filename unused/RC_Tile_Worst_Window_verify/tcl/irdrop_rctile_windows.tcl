...
# 参数: n_grid=8, k_theta=1.0, rho=0.7, eta=0.15, k_min=2
#
...
# ===== RC-Tile Window 1: 原始 6500~10050ns (拼接VCD: 0~3550ns) =====
puts "========================================"
puts "=== RC-Tile Window 1: 6500ns ~ 10050ns (orig) / 0~3550ns (spliced) ==="
puts "========================================"
...
read_activity_file -format VCD ../../vcd/test_rctile.vcd \
    -scope test/u0 \
    -start 0ns \
    -end 3550ns
set_dynamic_power_simulation -resolution 1ns
report_power -o ../../db/power/avg_v20_rctile_win1
...
set_power_data -format current \
    [list ../../db/power/avg_v20_rctile_win1/dynamic_VDD.ptiavg \
          ../../db/power/avg_v20_rctile_win1/dynamic_VSS.ptiavg]
...
analyze_rail -type domain -output ../../db/rail_power_v20_rctile_win1 PD

puts "=== RC-Tile Window 1 done ==="

puts "========================================"
puts "=== All rctile windows completed ==="
puts "========================================"
exit
