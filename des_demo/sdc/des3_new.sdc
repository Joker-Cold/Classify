...
set CLK_PERIOD 2000.0  ;# 2,000 ps = 2 ns = 500 MHz
...
set INPUT_DELAY  [expr $CLK_PERIOD * 0.2] ;# 20% of period for external input path
set OUTPUT_DELAY [expr $CLK_PERIOD * 0.2] ;# 20% of period for external output path
