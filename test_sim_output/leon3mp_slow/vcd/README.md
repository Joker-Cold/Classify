# leon3mp_slow — VCD 文件说明

| 文件 | 方法 | 命中窗口 | 保留时段/总时段 | 段数 | 大小 |
|---|---|---:|---:|---:|---:|
| `sim.vcd` | 原始完整 VCD | - | 100% | - | 116392 KB |
| `leon3mp_slow_hotspot_t0.8_traditional.vcd` | traditional (toggle) | 25/193 | 49897/385200 (13.0%) | 20 | 112084 KB |
| `leon3mp_slow_hotspot_t0.8_euclidean.vcd` | risk / euclidean | 25/193 | 49897/385200 (13.0%) | 20 | 112084 KB |
