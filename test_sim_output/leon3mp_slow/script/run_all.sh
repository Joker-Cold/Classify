#!/bin/bash
# =============================================================
# run_all.sh — Sequential P&R + Voltus for leon3mp_slow
# Usage: bash run_all.sh [traditional|risk_propagation]
# NOTE: Large design (649K cells) — P&R may take many hours
# =============================================================
...
echo "============================================"
echo "leon3mp_slow P&R + Voltus pipeline"
echo "Method: $METHOD"
echo "WARNING: This is a 649K cell design."
echo "============================================"
...
echo "[2/4] Running Innovus P&R (large design — may take hours) ..."
...
VCD_COMPRESSED="$CIRCUIT_DIR/vcd/leon3mp_slow_compressed_${METHOD}.vcd"
...
echo "ALL STEPS COMPLETE for leon3mp_slow"
