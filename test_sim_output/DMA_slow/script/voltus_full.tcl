# =============================================================
# voltus_full.tcl — Full VCD IR Drop analysis for DMA_slow
# Backend: ASAP7 tech LEF + contest cell LEF + ASAP7 QRC
# VDD = 0.7V, threshold = 0.651V (7% drop budget)
# =============================================================

set SCRIPT_DIR   [file dirname [file normalize [info script]]]
set CIRCUIT_DIR  [file dirname $SCRIPT_DIR]
set DES_DEMO_ENC [file normalize "$CIRCUIT_DIR/../../des_demo/db/des3.enc.dat"]
set SHARED_SCRIPTS [file normalize "$CIRCUIT_DIR/../scripts"]
...
set init_lef_file               [list \
    ...
    $SHARED_SCRIPTS/contest_cells.lef \
]
...
# ---- Generate PG Library (techonly with ASAP7 QRC) ----
...
puts "============================================"
puts "Voltus FULL VCD done for $TOP_CELL"
puts "  Power : $OUT_POWER"
puts "  Rail  : $OUT_RAIL"
puts "============================================"
