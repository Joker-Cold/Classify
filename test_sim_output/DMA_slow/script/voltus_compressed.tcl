# =============================================================
# voltus_compressed.tcl — Compressed VCD IR Drop for DMA_slow
# Backend: ASAP7 tech LEF + contest cell LEF + ASAP7 QRC
# Set METHOD env var before running:
#   export METHOD=traditional     (or risk_propagation)
# =============================================================
...
set VCD_SCOPE    tb/u0
set PG_LIB_DIR   $SCRIPT_DIR/pg_lib_full   ;# reuse PG lib generated by voltus_full
...
puts "============================================"
puts "Voltus COMPRESSED ($METHOD) done for $TOP_CELL"
puts "  VCD   : $VCD_FILE"
