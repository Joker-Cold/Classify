#!/bin/bash
# =============================================================
# run_all.sh — Sequential P&R + Voltus for vga_lcd_slow
...
echo "============================================"
echo "vga_lcd_slow P&R + Voltus pipeline"
echo "Method: $METHOD"
echo "============================================"
...
VCD_COMPRESSED="$CIRCUIT_DIR/vcd/vga_lcd_slow_compressed_${METHOD}.vcd"
...
echo "ALL STEPS COMPLETE for vga_lcd_slow"
