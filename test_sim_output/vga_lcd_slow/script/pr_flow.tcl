# =============================================================
# pr_flow.tcl — Innovus P&R for vga_lcd_slow (ISPD2012 contest)
# Physical backend: ASAP7 tech LEF + contest cell LEF
# Top cell  : vga_lcd_slow
# Clock     : ispd_clk / mclk, period 700ps
...
proc write_pads_from_corebox {fname} {
    ...
    puts $fh "$mx $y0";  puts $fh "$mx $y1"
    puts $fh "$x0 $my";  puts $fh "$x1 $my"
    close $fh
