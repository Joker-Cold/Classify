# vga_lcd_slow — VCD 文件说明

| 文件 | 方法 | 命中窗口 | 保留时段/总时段 | 段数 | 大小 |
|---|---|---:|---:|---:|---:|
| `sim.vcd` | 原始完整 VCD | - | 100% | - | 26667 KB |
| `vga_lcd_slow_hotspot_t0.8_traditional.vcd` | traditional (toggle) | 1/75 | 1998/149800 (1.3%) | 1 | 26062 KB |
| `vga_lcd_slow_hotspot_t0.8_euclidean.vcd` | risk / euclidean | 1/75 | 1998/149800 (1.3%) | 1 | 26062 KB |
